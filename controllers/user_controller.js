...
//MW que permite acciones solamente si el usuario objeto corresponde con el usuario logeado
...
exports.create = function(req, res){
	...
	user.validate().then(function(err){
		if(err){
			...
			user.save({fields: ["username", "password"]})	//Save: guarda en DB campos username y password de user
			.then(function(){
				//Crea la sesión para que el usuario acceda ya autenticado
